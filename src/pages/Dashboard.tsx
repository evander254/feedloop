              ...
              >
                <div className="p-5">
                  <div className="flex items-start justify-between">
                    <span
                      className={`flex size-12 items-center justify-center rounded-xl text-white shadow-lg ${card.iconBg}`}
                    >
                      <Icon size={24} />
                    </span>
                  ...
                  <div className="mt-5 flex items-center gap-2">
                    ...
                    {card.newPath && (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg px-3.5 py-2 text-xs font-bold text-white shadow-sm transition hover:opacity-90"
                        style={{
                          background: `linear-gradient(135deg, ${card.key === "forms" ? "#14b8a6" : card.key === "surveys" ? "#3b82f6" : card.key === "polls" ? "#f97316" : "#a855f7"}, ${card.key === "forms" ? "#059669" : card.key === "surveys" ? "#6366f1" : card.key === "polls" ? "#ef4444" : "#ec4899"})`,
                        }}
                      >
                        <Plus size={13} />
                        New
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${card.key === "forms" ? "#14b8a6" : card.key === "surveys" ? "#3b82f6" : card.key === "polls" ? "#f97316" : "#a855f7"}, ${card.key === "forms" ? "#059669" : card.key === "surveys" ? "#6366f1" : card.key === "polls" ? "#ef4444" : "#ec4899"})`,
                  }}
                />
              </div>
            );
